...
interface AdminOrderNotificationTemplateProps {
  orderNumber: string;
  customerName: string;
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '20px', backgroundColor: '#f5f5f5' }}>
        <h2 style={{ marginTop: 0 }}>Customer Information</h2>
        ...
        <div style={{ backgroundColor: '#fff3cd', padding: '15px', borderRadius: '8px', marginTop: '20px', border: '1px solid #ffc107' }}>
          <p style={{ margin: 0, fontSize: '12px', fontWeight: 'bold' }}>
            Action Required: Please prepare this order and confirm delivery details.
          </p>
        </div>
      </div>

      <div style={{ backgroundColor: '#1a1a1a', color: '#f5f5f5', padding: '20px', textAlign: 'center', fontSize: '12px' }}>
        <p style={{ margin: 0 }}>Sean Mark&apos;s Cuisine Admin</p>
